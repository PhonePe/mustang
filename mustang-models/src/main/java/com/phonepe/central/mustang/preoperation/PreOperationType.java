...
public enum PreOperationType {
    ...
    MULTIPLICATION(PreOperationType.MULTIPLICATION_TEXT),
    ...
    DATETIME(PreOperationType.DATETIME_TEXT);
    ...
    public static final String MULTIPLICATION_TEXT = "MULTIPLICATION";
