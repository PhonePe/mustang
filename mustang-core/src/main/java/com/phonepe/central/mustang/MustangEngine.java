...
import com.phonepe.central.mustang.index.IndexingFacade;
import com.phonepe.central.mustang.processor.AsyncProcessor;
import com.phonepe.central.mustang.ratify.RatificationRequest;
import com.phonepe.central.mustang.ratify.RatificationResult;
import com.phonepe.central.mustang.scan.Scanner;
import com.phonepe.central.mustang.search.Query;
import com.phonepe.central.mustang.search.QueryBuilder;
import com.phonepe.central.mustang.search.SearchFacade;
import com.phonepe.central.mustang.search.ranking.RankingStrategy;
import com.phonepe.central.mustang.similarity.SimilarityDetector;
...
public class MustangEngine {
    ...
    public SimilarityStats checkSimilarity(final String indexName, Criteria criteria) {
        return SimilarityDetector.builder()
                .mapper(mapper)
