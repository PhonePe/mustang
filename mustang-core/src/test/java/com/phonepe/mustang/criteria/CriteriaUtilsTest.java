...
import com.phonepe.mustang.criteria.tautology.DNFTautologicalCriteria;
...
public class CriteriaUtilsTest {
    ...
    private final Predicate predicateA = IncludedPredicate.builder()
            .lhs("$.a")
            .values(Sets.newHashSet("A1", "A2"))
            .build();

    private final Predicate predicateB = IncludedPredicate.builder()
            .lhs("$.b")
            .values(Sets.newHashSet("B1", "B2"))
            .build();

    private final Predicate predicateC = IncludedPredicate.builder()
            .lhs("$.c")
            .values(Sets.newHashSet("C1", "C2"))
            .build();

    private final Predicate predicateD = IncludedPredicate.builder()
            .lhs("$.d")
            .values(Sets.newHashSet("D1", "D2"))
            .build();

    private final Predicate predicateE = IncludedPredicate.builder()
            .lhs("$.e")
